<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"D:\phpstudy\PHPTutorial\WWW\blog\FastAdmin\public/../application/index\view\index\login.html";i:1548489012;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" href="/blog/FastAdmin/public//assets/css/login.css">
	...
	$("#submit").click(function(){
		...
		if(name==""){
			...
			$.post('<?php echo url("index/index/logininfo"); ?>',{'username':name,'password':pwd},function(data){
				if(data.result){
                   alert(data.msg);
                   window.location.href='/blog/FastAdmin/public/index.html';
				}else{
				alert(data.msg);
				}

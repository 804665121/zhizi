<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"D:\PHPTutorial\WWW\FastAdmin\public/../application/index\view\index\index.html";i:1548469914;s:70:"D:\PHPTutorial\WWW\FastAdmin\application\index\view\common\header.html";i:1548470184;s:72:"D:\PHPTutorial\WWW\FastAdmin\application\index\view\common\leftinfo.html";i:1548490452;s:70:"D:\PHPTutorial\WWW\FastAdmin\application\index\view\common\footer.html";i:1548224989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
				...
				<div id="myCarousel" class="carousel slide">
					...
					<div class="carousel-inner">
						<div class="item active">
							<img src="/FastAdmin/public//assets/img/tupian.png" class="carimg" alt="First slide">
						</div>
						<div class="item">
							<img src="/FastAdmin/public//assets/img/cat.jpg" class="carimg" alt="Second slide">
						</div>
						<div class="item">
							<img src="/FastAdmin/public//assets/img/pig2.jpg" class="carimg" alt="Third slide">
						</div>
						<!-- 轮播导航 -->
					...
					<article class="input_post">
						...
						<p><?php echo $vo['content']; ?><img src="/FastAdmin/public//assets/img/icon/emoji-6.svg" alt=""></p>

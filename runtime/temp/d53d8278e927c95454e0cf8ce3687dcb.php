<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"D:\PHPTutorial\WWW\FastAdmin\public/../application/index\view\index\articleinfo.html";i:1548407671;s:70:"D:\PHPTutorial\WWW\FastAdmin\application\index\view\common\header.html";i:1548382025;s:72:"D:\PHPTutorial\WWW\FastAdmin\application\index\view\common\leftinfo.html";i:1548385117;s:70:"D:\PHPTutorial\WWW\FastAdmin\application\index\view\common\footer.html";i:1548224989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="/FastAdmin/public/index/index/article">php</a></li>
								<li><a href="#">js</a></li>
								<li><a href="#">句子</a></li>
							</ul>
						</li>
...
$(function(){
	...
	<div class="mainbox">
		<div class="leftinfo">
	<img src="/FastAdmin/public//assets/img/touxiang.jpg"   class="head_imgs" alt="" style="">
	<h1 class="lefttitle" >ZHIZIblog
		<p class="titleinfo">blog...</p>
	</h1>
	<div  class="leftlist">
	...
	<a href="/FastAdmin/public/index/index/login" class="left_buttom" >登录</a>
		...
		<div class="rights">
			...
			<div class="artright">
				<h2><a href="/FastAdmin/public/index/index/articleinfo"><?php echo $v['atitle']; ?></a></h2>
				<p class="artinfo">
				...
				<div>
					<!-- <img src="/FastAdmin/public//assets/img/tupian.png" class="infoimg"  alt=""> -->
					<div class="imgright">
						<p><?php echo $v['acontent']; ?></p>
					</div>
				</div>
				<p class="bottom_info">

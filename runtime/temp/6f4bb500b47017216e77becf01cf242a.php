<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\PHPTutorial\WWW\FastAdmin\public/../application/admin\view\home\edit.html";i:1548466723;s:71:"D:\PHPTutorial\WWW\FastAdmin\application\admin\view\layout\default.html";i:1547349021;s:68:"D:\PHPTutorial\WWW\FastAdmin\application\admin\view\common\meta.html";i:1547349021;s:70:"D:\PHPTutorial\WWW\FastAdmin\application\admin\view\common\script.html";i:1547349021;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-intro" class="form-control" name="row[intro]" type="text" value="<?php echo $row['intro']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Content'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-content" class="form-control editor" name="row[content]" type="textarea" value="<?php echo $row['content']; ?>">
        </div>
    </div>
    <div class="form-group">
